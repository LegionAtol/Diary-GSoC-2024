...
As you can see, the number of steps used for each episode decreases until the "local" minimum number is found.  
"local" in the sense of these program settings (system dynamics, training length, various parameters...).  
Theoretically it could be achieved with just one step.
...
In the code above, I used many parameters as they were initially used in the paper cited at the beginning of this post.  
...
For completeness the code is as follows  
